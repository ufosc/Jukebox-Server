 ...
 */
export const httpOk = (res: Response, data?: any, showStatus?: boolean): any => {
 ...
 */
export const httpCreated = (res: Response, data?: any, showStatus?: boolean): any => {
 ...
 */
export const httpNoContent = (res: Response): any => {
  res.status(204).send()
}
 ...
 */
export const httpFound = (res: Response, uri: string, headers?: { [field: string]: string }) => {
 ...
 */
export const httpSeeOther = (res: Response, uri: string, headers?: { [field: string]: string }) => {
 ...
 */
export const httpBadRequest = (res: Response, message?: any, showStatus: boolean = true): any => {
 ...
 */
export const httpUnauthorized = (res: Response, message?: any, showStatus: boolean = true): any => {
 ...
 */
export const httpForbidden = (res: Response, message?: any, showStatus: boolean = true): any => {
 ...
 */
export const httpNotFound = (res: Response, message?: any, showStatus: boolean = true): any => {
 ...
 */
export const httpConflict = (res: Response, message?: any, showStatus: boolean = true): any => {
 ...
 */
export const httpGone = (res: Response, message?: any, showStatus: boolean = true): any => {
 ...
 */
export const httpBadGateway = (res: Response, message?: any, showStatus: boolean = true): any => {
 ...
 */
export const httpServiceUnavailable = (
  res: Response,
  message?: any,
  showStatus: boolean = true
): any => {
 ...
 */
export const httpGatewayTimeout = (
  res: Response,
  message?: any,
  showStatus: boolean = true
): any => {
 ...
 */
export const httpNetworkAuthenticationRequired = (
  res: Response,
  message?: any,
  showStatus: boolean = true
): any => {
