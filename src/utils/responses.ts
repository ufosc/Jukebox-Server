 ...
 */
export const found = (res: Response, uri: string, headers?: { [field: string]: string }) => {
 ...
 */
export const seeOther = (res: Response, uri: string, headers?: { [field: string]: string }) => {
 ...
 */
export const methodNotAllowed = (res: Response, message?: any) => {
 ...
 */
export const gone = (res: Response, message?: any) => {
 ...
 */
export const internalServerError = (res: Response, message?: any) => {
 ...
 */
export const notImplemented = (res: Response, message?: any) => {
 ...
 */
export const badGateway = (res: Response, message?: any) => {
 ...
 */
export const serviceUnavailable = (res: Response, message?: any) => {
 ...
 */
export const gatewayTimeout = (res: Response, message?: any) => {
 ...
 */
export const networkAuthenticationRequired = (res: Response, message?: any) => {
